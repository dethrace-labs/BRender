...
#define ScalarsToRGB15(r, g, b) (((b) >> 19) & 0x1f | ((g) >> 14) & 0x3e0 | ((r) >> 9) & 0x7c00)

#define ScalarsToRGB16(r, g, b) (((b) >> 19) & 0x1f | ((g) >> 13) & 0x7c0 | ((r) >> 8) & 0xf800)

#define ScalarsToRGB24(r, g, b) (((b) >> 16) & 0xff | ((g) >> 8) & 0xff00 | ((r) >> 8) & 0xff0000)
...
void BR_ASM_CALL LineRenderPIT(struct brp_block *block, ...)
{
    br_fixed_ls dx, dy;
