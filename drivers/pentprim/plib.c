...
static struct br_tv_template_entry argsTemplateEntries[] = {
    {
     DEV(PROCESSOR_T),
     F(processor_type),
     BRTV_SET,       BRTV_CONV_COPY,
     },
    {
     DEV(USE_MMX_B),
     F(use_mmx),
     BRTV_SET, BRTV_CONV_I32_B,
     },
};
#undef F

static struct br_tv_template argsTemplate = {BR_ASIZE(argsTemplateEntries), argsTemplateEntries};
...
static br_error BR_CMETHOD_DECL(br_primitive_library_soft, stateNew)(struct br_primitive_library *self,
...
static br_error BR_CMETHOD_DECL(br_primitive_library_soft,
                                bufferStoredNew)(struct br_primitive_library *self, struct br_buffer_stored **psm,
...
static br_error BR_CMETHOD_DECL(br_primitive_library_soft, bufferStoredAvail)(struct br_primitive_library *self,
                                                                              br_int_32 *space, br_token use,
                                                                              br_token_value *tv)
{
    /*
...
static br_error BR_CMETHOD_DECL(br_primitive_library_soft, flush)(struct br_primitive_library *self, br_boolean wait)
{
...
static br_error BR_CMETHOD_DECL(br_primitive_library_soft, synchronise)(struct br_primitive_library *self,
...
static br_error BR_CMETHOD_DECL(br_primitive_library_soft, mask)(struct br_primitive_library *self, br_uint_32 *mask,
