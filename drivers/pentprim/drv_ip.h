...
struct br_buffer_stored *BufferStoredSoftAllocate(struct br_primitive_library *plib, br_token use,
...
void BR_ASM_CALL LineRenderPIT(brp_block *block, ...);
...
void BR_ASM_CALL TriangleRenderPITIAD(struct brp_block *block, union brp_vertex *v0, union brp_vertex *v1,
                                      union brp_vertex *v2);
 ...
 * decalz.c
 */
void BR_ASM_CALL TriangleRenderPIZ2TAD(struct brp_block *block, union brp_vertex *v0, union brp_vertex *v1,
                                       union brp_vertex *v2);
void BR_ASM_CALL TriangleRenderPIZ2TIAD(struct brp_block *block, union brp_vertex *v0, union brp_vertex *v1,
                                        union brp_vertex *v2);
