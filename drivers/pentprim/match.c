...
static const struct prim_info_table primInfoTables[4][3] = {
    {
     {
            primInfo_p8,
            BR_ASIZE(primInfo_p8),
        }, {
            primInfo_l8,
            BR_ASIZE(primInfo_l8),
        }, {
            primInfo_t8,
            BR_ASIZE(primInfo_t8),
        }, },
 //{
  //  {
  //         primInfo_p15,
  //         BR_ASIZE(primInfo_p15),
  //     },        {
  //         primInfo_l15,
  //         BR_ASIZE(primInfo_l15),
  //     },                  {
  //         primInfo_t15,
  //         BR_ASIZE(primInfo_t15),
  //     }, },
  // {
  //  {
  //         primInfo_p16,
  //         BR_ASIZE(primInfo_p16),
  //     }, {
  //         primInfo_l16,
  //         BR_ASIZE(primInfo_l16),
  //     }, {
  //         primInfo_t16,
  //         BR_ASIZE(primInfo_t16),
  //     }, },
  // {
  //  {
  //         primInfo_p24,
  //         BR_ASIZE(primInfo_p24),
  //     },          {
  //         primInfo_l24,
  //         BR_ASIZE(primInfo_l24),
  //     },                 {
  //         primInfo_t24,
  //         BR_ASIZE(primInfo_t24),
  //     }, }
};
...
br_error BR_CMETHOD_DECL(br_primitive_state_soft, renderBegin)(struct br_primitive_state *self, struct brp_block **rpb,
                                                               br_boolean *block_changed, br_boolean *ranges_changed,
                                                               br_boolean no_render, br_token prim_type)
{
    int                 i, j, b, nb;
    ...
    *ranges_changed = BR_TRUE;
    ...
    if(self->prim.custom_block) {
        ...
        if(work.texture.type != PMT_NONE) {
             ...
             */
            if(isPowerof2(work.texture.width_p) && isPowerof2(work.texture.height) && work.texture.width_p <= 1024 &&
...
br_error BR_CMETHOD_DECL(br_primitive_state_soft, renderEnd)(struct br_primitive_state *self, struct brp_block *pb)
{
...
void BR_ASM_CALL GenericAutoloadThunk(brp_block *block, brp_vertex *v0, brp_vertex *v1, brp_vertex *v2)
{
    ...
    if(pb->setup.rasterise_rl_l == NULL || pb->setup.rasterise_lr_l == NULL || pb->setup.rasterise_rl_s == NULL ||
...
br_error BR_CMETHOD_DECL(br_primitive_state_soft, rangesQueryF)(struct br_primitive_state *self, br_float *offset,
                                                                br_float *scale, br_int_32 max_comp)
{
    int i;
...
br_error BR_CMETHOD_DECL(br_primitive_state_soft, rangesQueryX)(struct br_primitive_state *self, br_fixed_ls *offset,
                                                                br_fixed_ls *scale, br_int_32 max_comp)
{
    int i;
